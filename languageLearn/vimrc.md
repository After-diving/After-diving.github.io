...
<pre class="language-" style="height:400px;overflow-y:auto"><code class="lang-bash">colorscheme molokai                              " 设置主题
setlocal list
...
## HTML 格式的 prism 使用
```html
<pre class="language-" style="height:380px;overflow-y:auto"><code class="lang-bash">
```
